##########################################################################################################
# This script is used for capturing calibration and performance scores for enhanced expectation based system
##########################################################################################################
...
def predict_y_class_by_reg_10_10(data_test_X_class, model_path_class, model_path_reg,decision_point):
    """
...
result_file_char='results_reg_10_10_'+str(decision_point)+'.csv'
...
data_test_X_class, data_test_y_class = capture_test_data_label_class(test_data_label_path_class, data_file_class,
                                                                         label_file_class)
predicted_class_array, predicted_class_proba_array = predict_y_class_by_reg_10_10(data_test_X_class, model_path_class, model_path_reg,decision_point)
