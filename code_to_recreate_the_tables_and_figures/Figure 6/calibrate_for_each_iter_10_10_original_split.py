...
result_file_train = 'results_iter_reg_separate_10_10_train_' + str(decision_point) + '.csv'
result_file_test = 'results_iter_reg_separate_10_10_test_' + str(decision_point) + '.csv'
...
data_train_X_class, data_train_y_class = organize_train_data(list_train_ckt_names_class, train_data_label_path_class,
                                                             data_file_class, label_file_class)
data_test_X_class, data_test_y_class = organize_train_data(list_test_ckt_names_class, test_data_label_path_class,
                                                           data_file_class, label_file_class)
