############################################################################################
# This script trains K Nearest Neighbor Classifier with n_neighbors=10 and saves the model
###########################################################################################
...
print(header)
print(str(decision_point) +','+ 'classifier_knn'+ ','+ str(mean_accuracy_train) +','+ str(tp_train) +','+ str(tn_train) +','+ str(fp_train) +','+ str(fn_train) +','+ str(mcc_train))
print('    Save the model : '+'mvto-' + str(decision_point) + '-1_knn')
save_file_name = 'mvto-' + str(decision_point) + '-1_knn'
