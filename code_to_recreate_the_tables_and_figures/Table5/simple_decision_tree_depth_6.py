#######################################################################################
# This script trains a simple decision tree model for max_depth=6 and saves the model
#######################################################################################
...
print(header)
print(str(decision_point) +','+ 'classifier_decision_tree_d6'+ ','+ str(mean_accuracy_train) +','+ str(tp_train) +','+ str(tn_train) +','+ str(fp_train) +','+ str(fn_train) +','+ str(mcc_train))
print('    Save the model : '+'mvto-' + str(decision_point) + '-1_decision_tree_d6')
save_file_name = 'mvto-' + str(decision_point) + '-1_decision_tree_d6'
