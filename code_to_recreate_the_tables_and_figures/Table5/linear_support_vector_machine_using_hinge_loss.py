####################################################################################################
# This script trains linear support vector machine-based model using hinge loss and saves the model
###################################################################################################
...
print(header)
print(str(decision_point) +','+ 'classifier_sgd_linear_svm'+ ','+ str(mean_accuracy_train) +','+ str(tp_train) +','+ str(tn_train) +','+ str(fp_train) +','+ str(fn_train) +','+ str(mcc_train))
print('    Save the model : '+'mvto-' + str(decision_point) + '-1_sgd_linear_svm')
save_file_name = 'mvto-' + str(decision_point) + '-1_sgd_linear_svm'
